# Analytics Report AI Documentation

Analytics Report AI is a WordPress admin plugin that helps administrators turn selected GA4 report data into an AI-assisted Japanese report draft.
...
7. Generate a Japanese report draft with OpenAI.
