...
7. Generate a report draft in the current WordPress user language through the WordPress AI Client.
8. Review, edit, and copy the draft.

Fetch GA4 Data and Generate AI Report are separate actions. The configured AI provider is not contacted when GA4 data is fetched, and Google Analytics data is not fetched when only generating from already reviewed report data.
